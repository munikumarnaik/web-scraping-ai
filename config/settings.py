...
# Railway healthcheck requires this
if 'railway.app' in ','.join(ALLOWED_HOSTS):
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'domain_intelligence'),
...
# Map R2 to AWS S3-compatible variables (used internally by boto3)
...
SCRAPING_PROVIDER = os.getenv('SCRAPING_PROVIDER', 'firecrawl')  # 'firecrawl' or 'beautifulsoup'
